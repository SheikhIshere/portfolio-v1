...
export function Projects() {
  ...
  const projects: Project[] = [
    {
      ...
      overview: 'A full-featured library management system designed to handle book inventory, member management, and borrowing workflows. Built with scalability and performance in mind.',
      architecture: {
  ...
  "results": [
    ...
    },
    {
      ...
      githubUrl: '<github-repo-url>',
      demoUrl: '<live-demo-url>',
      overview: 'A modern job platform that streamlines the hiring process with real-time communication, automated resume parsing, and intelligent job matching.',
      architecture: {
  ...
  "submitted_at": "2024-12-21T11:00:00Z"
    ...
    {
      id: 'ghorer-ukil',
      title: 'Ghorer Ukil - Legal Consultation',
      description: 'Platform connecting clients with lawyers for legal consultations and case management.',
      stack: ['Django', 'DRF', 'PostgreSQL', 'Stripe', 'Celery'],
      highlights: [
      ...
      githubUrl: '<github-repo-url>',
      demoUrl: '<live-demo-url>',
      overview: 'A legal tech platform that makes legal consultation accessible with online booking, secure payments, and comprehensive case management tools.',
      architecture: {
        erd: `Client (id, name, email, phone)\n  |\n  | 1:N\n  |\nConsultation (id, lawyer_id, client_id, status, payment)\n  |\n  | N:1\n  |\nLawyer (id, name, specialization, rate)\n  |\n  | 1:N\n  |\nCase (id, title, documents, status)`,
        deployment: `Client → Nginx → Django\n              |\n              ├→ PostgreSQL (Cases)\n              ├→ S3 (Documents)\n              ├→ Stripe (Payments)\n              └→ Celery (Emails)`
      },
      apiExamples: [
        {
          method: 'POST',
  ...
  "updates": [...]
      ...
      features: [
        'Lawyer profile and availability management',
      ...
      testing: 'Integration tests for payment flow. Unit tests for booking logic. 90% test coverage.'
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {projects.map((project) => (
              ...
              >
                ...
                <div className="h-48 bg-gradient-to-br from-[#0EA5A4]/20 to-[#0EA5A4]/5 flex items-center justify-center">
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4 text-center">
                    <span className="text-sm text-[#0EA5A4] hover:underline">
                      Click for details →
                    </span>
                  </div>
                </div>
